...
//  iosApp
//
//  Created by Ayodele Kehinde on 26/04/2023.
...
public struct UIPilotHost<T: Equatable, Screen: View>: View {
    ...
    public init(@ViewBuilder _ routeMap: @escaping (T) -> Screen) {
...
//            }
//        }
//        uipilot.onPushWithPop = { path in
//            navigation.viewControllers[0] = UIHostingController(rootView: routeMap(path))
//            navigation.popToRootViewController(animated: true)
//        }
//        uipilot.onPushWithPopUpToLast = { path in
//            let home = DashboardRoute.Home as? T ?? AgentAppRoute.Home as? T
//            navigation.viewControllers[0] = UIHostingController(rootView: routeMap(home!))
//            navigation.viewControllers[1] = UIHostingController(rootView: routeMap(path))
//            let index = navigation.viewControllers.startIndex + 1
//            let popTo = navigation.viewControllers[index]
//            navigation.popToViewController(popTo, animated: true)
//
//        }
    ...
    func updateUIViewController(_ navigation: UINavigationController, context: Context) {
        ...
        navigation.topViewController?.navigationItem.backButtonTitle = "Back"
    }
